...
_G.packer_plugins = {
  ...
  ["nvim-surround"] = {
    loaded = true,
    path = "/home/dhiroshi/.local/share/nvim/site/pack/packer/start/nvim-surround",
  ...
  ["telescope-symbols.nvim"] = {
    loaded = true,
    path = "/home/dhiroshi/.local/share/nvim/site/pack/packer/start/telescope-symbols.nvim",
