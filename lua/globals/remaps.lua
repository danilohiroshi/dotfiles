...
vim.keymap.set('n', '<C-S-i>', ":bprevious<CR>")
vim.keymap.set('n', '<c-w>', ":bd<CR>")
vim.keymap.set('i', '<C-i>', "<esc>:bnext<CR>")
vim.keymap.set('i', '<C-S-i>', "<esc>:bprevious<CR>")
vim.keymap.set('i', '<c-w>', "<esc>:bd<CR>")
vim.keymap.set('v', '<C-i>', "<esc>:bnext<CR>")
vim.keymap.set('v', '<C-S-i>', "<esc>:bprevious<CR>")
